...
class CornerTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Path path = Path()
      ...
      ..relativeLineTo(
          longSideLength * xTurn, -(shortSideLength - cutOfLength) * yTurn)
      ...
      children: [
        ...
        CustomPaint(
          painter: BorderPainter(
              path: path, width: borderWidth, color: Colors.black),
        ),
      ],
    );
  }
        ...
        child: isKnown
            ? Column(
                children: [
                  ...
                  Text(score.toString(), style: theme.textTheme.bodyText1),
                ],
              )
            : Container(
                padding: isCornerLeft
...
class BorderPainter extends CustomPainter {
  ...
  BorderPainter(
      {@required this.path, @required this.width, @required this.color});
