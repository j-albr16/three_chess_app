  ...
  void changeMoveState(String newTile, BuildContext context){
    ...
    if(!isMoveState){
      ...
      Piece piece = pieces.firstWhere((e) => e.position == selectedTile);
        print(thinkingBoard.getLegalMove(selectedTile, piece, context).toString());

      print('MoveState: ON');
      if(true){ // thinkingBoard.getLegalMove(selectedTile, selectedPiece, context).contains(newTile)
